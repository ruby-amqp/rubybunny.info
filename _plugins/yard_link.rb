  ...
  class YardLink < ::Liquid::Tag
    ...
    def initialize(tag_name, markup, tokens)
      if markup =~ Syntax
        ...
        raise ::Liquid::SyntaxError.new("Syntax Error in 'link' - Valid syntax: yard_link <reference>")
      end
    ...
    def render(context)
      %{<a class="highlight" href="http://rubydoc.info/github/ruby-amqp/bunny/master/#{calculate_path(@class_name)}">#{@class_name}</a>}
    end
  end
end
